...
def process_data_set (path):
    ...
    process_dataset_folder(path+"train\\without_mask\\",lista_train_without_mask,"train",0,train,test)
    process_dataset_folder(path+"train\\with_mask\\",lista_train_with_mask,"train",1,train,test)
    process_dataset_folder(path+"test\\with_mask\\",lista_test_with_mask,"test",1,train,test)
    process_dataset_folder(path+"test\\without_mask\\",lista_test_without_mask,"test",0,train,test)
